# Patients CRUD exercise

In this exercise you will create a Patients CRUD app.
...
The project loads fake patients when the store is initialized.

You challenge is to display the patients, then create a patient form
to add new patients, and create a patient page to view patient information when selected from the patient list. Then edit the patient
when clicking the edit button from the patient show screen. Finally,
prompting and removing the patient when clicking the remove button
from the view patient screen.
